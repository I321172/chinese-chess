...
export default class ChessMen extends Component {
    ...
    handleConfirm = () => {
        if (this.state.joinType === 'single') {
            this.single();
        } else if (this.state.joinType === 'replay') {
            // this.start();
        } else {
            // this.join();
        }
    ...
    render() {
        return (
            <div className="chess-men">
                {this.state.isReady ? null : <div className="btn-start"
                                                  onClick={() => this.setState({isShowModel: !this.state.isShowModel})}>开始游戏</div>}
                {
                        ...
                        <div className="game-modal">
                            ...
                            <div className="game-modal-content">
                                <div className="game-item" onClick={() => this.setState({joinType: 'single'})}>
                                    <input type="radio" name="joinType" value="single"
                                           checked={this.state.joinType === 'single'}/><label>坐在一起玩</label>
                                </div>
                                <div className="game-item" onClick={() => this.setState({joinType: 'replay'})}>
                                    <input type="radio" name="joinType" value="replay"
                                           checked={this.state.joinType === 'replay'}/><label>棋谱</label>
                                </div>
                                <div className="game-item" onClick={() => this.setState({joinType: 'goReplay'})}>
                                    <input type="radio" name="joinType" value="goReplay"
                                           checked={this.state.joinType === 'goReplay'}/><label>走棋谱</label>
                                </div>
